    ...
    <div className="my-8 flex justify-center items-center md:flex-row flex-col md:gap-8">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-2 max-w-[550px]">
          <input type="checkbox" className="h-6 w-8 border" />
          <p className="tarrif-text2">
            Я согласен с{" "}
        ...
        <button className="cursor-pointer mr-auto tarrif-button px-26 py-4 text-xl rounded-[20px] font-bold">
          Купить
        </button>
